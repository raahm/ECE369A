...
##This portion assigns buttons to be used for Instruction reset and Clk reset
set_property IOSTANDARD LVCMOS33 [get_ports {Reset}]
set_property PACKAGE_PIN P17 [get_ports {Reset}]

set_property IOSTANDARD LVCMOS33 [get_ports {ResetClk}]
set_property PACKAGE_PIN N17 [get_ports {ResetClk}]